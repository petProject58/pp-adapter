...
2.  "Clients" (Соседний сервис лежит в репозитории рядом , нужно его поднять на другом хосту чтобы была возможность тестировать ).
4. Сервис должен отправлять информацию о клиентах, которым необходимо отправить уведомление, в сервис "SMS".
5. Сервис должен сохранять информацию о клиентах, у которых номер телефона заканчивается на 7 и у которых день рождения в текущем месяце.
